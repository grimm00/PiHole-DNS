...
2. **Execute Group 1** — [`tasks/01-dashboards-and-exporter-fit.md`](tasks/01-dashboards-and-exporter-fit.md) is expanded; work Tasks 1–4 and keep [`spike-outcomes.md`](spike-outcomes.md) current.
